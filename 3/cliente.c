...
int main(int argc, char **argv) {
   ...
   //Alterações exercício 4
   /* A função getsockname obtém as informações do socket
      A função inet_ntop converte o endereço de IP da estrutura do socket de bi-
      nário para texto*/
   ...
   //Alterações exercício 5
   /* Aqui o caracter "O" foi definido para ser enviado em seguida ao socket de
   comunicação*/
